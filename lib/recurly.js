...
module.exports = function(config) {
  ...
  this.coupons = {
    ...
    uniqueCouponCodes: function (couponCode, params, callback) {
      var query = utils.addParams(routes.coupons.uniqueCouponCodes, {
        coupon_code: couponCode
      });
      query = utils.addQueryParams(query, params);

      t.request(query, callback);
    }
  };
